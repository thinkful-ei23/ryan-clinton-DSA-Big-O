...
//linear, if statement does not contribute
...
//complexity: exponential, o(2^n). input increases complexity by causing more iterations. each layer of recursion doubles in size
